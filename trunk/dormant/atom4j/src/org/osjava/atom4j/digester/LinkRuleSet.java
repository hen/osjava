...
public class LinkRuleSet implements RuleSet, DigesterRulesSource
{
    ...
    public LinkRuleSet(String path) {
        super();
        this.path = path;
    }
    
    public LinkRuleSet(String path, String namespace) {
        super();
        this.path = path;
    ...
    {
        digester.addObjectCreate( path, Link.class.getName());
        digester.addSetProperties(path);
        digester.addSetNext(path, "addLink", Link.class.getName());
    }
