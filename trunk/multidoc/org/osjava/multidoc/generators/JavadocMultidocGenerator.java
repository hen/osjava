...
public class JavadocMultidocGenerator implements MultidocGenerator {
    ...
    public void writeProjectFrame(Writer writer, DocumentSite site) throws IOException {
...
//        writer.write("<form action='' target='packageListFrame'><input type='text' name='query' size='15'/><FONT CLASS='FrameItemFont'><input type='submit' value='Find'></FONT></form>\n");
        ...
        Iterator iterator = site.getDocuments().iterator();
    ...
    public void writePackagesFrame(Writer writer, DocumentSite site) throws IOException {
...
//        writer.write("<FONT CLASS='FrameItemFont'><A HREF='allclasses-frame.html' target='packageFrame'>All Classes</A></FONT>\n");
    ...
    public void writeOverviewFrame(Writer writer, DocumentSite site) throws IOException {
...
//        writer.write("<a href=''><FONT CLASS='NavBarFont1'><b>Index</a></b></FONT></a>\n");
        ...
        while(iterator.hasNext()) {
            ...
            if(doc.isSinglePackage()) {
                writer.write("/");
                writer.write(((DocumentPackage)doc.getPackages().get(0)).getUrl());
                writer.write("'>");
            } else {
